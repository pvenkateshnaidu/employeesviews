...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <a href="{{ url('home') }}"><img  src="https://webmobilez.com/consultants/css/Group%201.png" 
                                                   height="50px" class="svg-content"></a>
    <!-- Topbar Navbar -->
    <ul class="navbar-nav ml-auto">
        
        <li class="nav-item  no-arrow">
            <a class="nav-link " href="{{url('timesheet')}}"  role="button" >
                <span class="mr-2 d-none d-lg-inline small btn btn-web">Time Sheets</span>
            </a>
        </li>         
